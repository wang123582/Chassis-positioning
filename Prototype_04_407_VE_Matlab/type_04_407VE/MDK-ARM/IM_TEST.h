...
typedef struct {
  ...
  real32_T Probe[2];                   /* '<S6>/Probe' */
  real32_T Probe_f[2];                 /* '<S8>/Probe' */
  real32_T DiscreteTimeIntegrator_DSTATE;/* '<S8>/Discrete-Time Integrator' */
  real32_T UnitDelay1_DSTATE;          /* '<S8>/Unit Delay1' */
  real32_T DiscreteTimeIntegrator_DSTATE_d;/* '<S6>/Discrete-Time Integrator' */
  real32_T UnitDelay1_DSTATE_p;        /* '<S6>/Unit Delay1' */
...
typedef struct {
  ...
  real32_T X_ACCIN;                    /* '<Root>/X_ACCIN' */
  real32_T Y_ACCIN;                    /* '<Root>/Y_ACCIN' */
} ExtU;
...
typedef struct {
  ...
  real32_T X_ACCOUT;                   /* '<Root>/X_ACCOUT' */
  real32_T Y_ACCOUT;                   /* '<Root>/Y_ACCOUT' */
} ExtY;
